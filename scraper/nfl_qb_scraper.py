...
NFL_QBS = [
    ...
    ('FavrBr00', 'Brett Favre', 1969),
    ('RoetBe00', 'Ben Roethlisberger', 1982),
    ('RivePh00', 'Philip Rivers', 1981),
    ('RyanMa00', 'Matt Ryan', 1985),
    ('MariDa00', 'Dan Marino', 1961),
    ('MannEl00', 'Eli Manning', 1981),
    ('ElwaJo00', 'John Elway', 1960),
    ('MoonWa00', 'Warren Moon', 1956),
    ('WilsRu00', 'Russell Wilson', 1988),
    ('PalmCa00', 'Carson Palmer', 1979),
    ('TestVi00', 'Vinny Testaverde', 1963),
    ('BledDr00', 'Drew Bledsoe', 1972),
    ('CarrDe02', 'Derek Carr', 1991),
    ('MontJo01', 'Joe Montana', 1956),
    ('McNaDo00', 'Donovan McNabb', 1976),
    ('HassMa00', 'Matt Hasselbeck', 1975),
    ('SmitAl03', 'Alex Smith', 1984),
    ('CutlJa00', 'Jay Cutler', 1983),
    ('FitzRy00', 'Ryan Fitzpatrick', 1982),
    ('TannRy00', 'Ryan Tannehill', 1988),
    ('RomoTo00', 'Tony Romo', 1980),
    ('YounSt00', 'Steve Young', 1961),
    ('AikmTr00', 'Troy Aikman', 1966),
    ('NewtCa00', 'Cam Newton', 1989),
    ('WarnKu00', 'Kurt Warner', 1971),
    ('BrunMa00', 'Mark Brunell', 1970),
    ('CunnRa00', 'Randall Cunningham', 1963),
    ('PlumJa00', 'Jake Plummer', 1974),
    ('JohnBr00', 'Brad Johnson', 1968),
    ('GannRi00', 'Rich Gannon', 1965),
    ('GreeTr00', 'Trent Green', 1970),
    ('HarbJi00', 'Jim Harbaugh', 1963),
    ('WinsJa00', 'Jameis Winston', 1994),
    ('CulpDa00', 'Daunte Culpepper', 1977),
    ('WatsDe00', 'Deshaun Watson', 1995),
    ('GaroJi00', 'Jimmy Garoppolo', 1991),
    ('TaylTy00', 'Tyrod Taylor', 1989),
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"NFL QB STATS SCRAPER - Opera GX with VPN")
    print(f"{len(qb_list)} players queued (duplicates auto-skipped)")
    print(f"Tables: Passing, Advanced Passing, Adjusted Passing,")
    print(f"        Rushing/Receiving, Advanced Rush/Rec, Defense, Snap Counts")
    print(f"{'='*70}")
