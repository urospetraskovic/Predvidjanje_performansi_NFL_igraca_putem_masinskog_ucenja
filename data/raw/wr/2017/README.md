...
dataset_info:
  ...
  - name: full
    num_bytes: 3512856
    num_examples: 4332
  download_size: 654450
  dataset_size: 3512856
configs:
- config_name: default
  data_files:
  - split: full
...
# NFL Wide Receiver Performance Dataset (2017)

## Dataset Description

This dataset contains comprehensive wide receiver performance statistics derived from NFL play-by-play data for the **2017**. It includes game-level metrics, situational targeting patterns, defensive adjustments, and advanced efficiency calculations.

### Dataset Summary

- **Season**: 2015
- **Records**: ~4.3k player-game observations
